...
export default function IndexPage() {
	return (
		<>
			<header className="flex h-16 w-full items-center px-12">
				<div className="flex w-full items-center justify-between space-x-12">
					...
					<nav className="flex items-center gap-6 text-sm font-medium text-foreground/60 transition-colors">
						<Link className="mr-2 hover:text-muted-foreground/80" href="/login">
							Login
						</Link>
					</nav>
				</div>
			...
			<section className="flex min-h-[calc(100vh-5rem)] flex-col items-center justify-center space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-24">
				<div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
					<Icons.logo className="h-14 w-14 fill-primary sm:h-20 sm:w-20" />
